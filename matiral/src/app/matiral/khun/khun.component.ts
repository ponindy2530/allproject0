...
@Component({
  selector: 'app-khun',
  templateUrl: './khun.component.html',
  styleUrls: ['./khun.component.css']
})
export class KhunComponent implements OnInit {
  msgs: Message[] = [];
  msgs2: Message[] = [];
  ...
  ngOnInit() {
    ...
    this._productService.dbData(92)
      .subscribe(resproducts => this.models88 = resproducts,
      err => console.log(err)
      // , () => { }
      );
  ...
  onRowSelect(ev: any) {
    this.hhname = ev.name_distribute;
    this._productService.dbData1(98,ev.id_distribute)
      .subscribe(resproducts => this.models = resproducts,
      err => console.log(err)
      // , () => { }
      );
