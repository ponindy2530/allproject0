...
@Component({
  selector: 'app-group3-sw',
  templateUrl: './group3-sw.component.html',
  styleUrls: ['./group3-sw.component.css']
})
export class Group3SwComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this._productService.dbData(83)
