...
@Component({
  selector: 'app-group1-sw',
  templateUrl: './group1-sw.component.html',
  styleUrls: ['./group1-sw.component.css']
})
export class Group1SwComponent implements OnInit {
  ...
  clickcolk(k: number, hcode: string) {
    this.colk = k;
    this.hc = hcode;
    this._productService.dbData1(78, hcode)
      .subscribe(resproducts => this.models = resproducts,
      err => console.log(err)
      // , () => { }
      );
